...
#pragma region SCENE W3
	void Scene_W3::Initialize()
	{
		...
		AddPlane(Vector3{ 0.f, 0.f, 10.f }, Vector3{ 0.f, 0.f, -1.f }, matId_Solid_Red); //BACK
		AddPlane(Vector3{ 0.f, 0.f, 0.f }, Vector3{ 0.f, 1.f, 0.f }, matId_Solid_Blue); //BOTTOM
		AddPlane(Vector3{ 0.f, 10.f, 0.f }, Vector3{ 0.f, -1.f, 0.f }, matId_Solid_Blue); //TOP
		...
		AddSphere(Vector3{ -1.75f, 1.f, 0.f }, .75f, matId_Solid_Yellow);
		AddSphere(Vector3{ 0.f, 1.f, 0.f }, .75f, matId_Solid_Magenta);
		AddSphere(Vector3{ 1.75f, 1.f, 0.f }, .75f, matId_Solid_Yellow);
