...
namespace dae
{
	...
	public:
		...
		Scene_W4_BunnyScene(const Scene_W1&) = delete;
		Scene_W4_BunnyScene(Scene_W1&&) noexcept = delete;
		Scene_W4_BunnyScene& operator=(const Scene_W1&) = delete;
		Scene_W4_BunnyScene& operator=(Scene_W1&&) noexcept = delete;
